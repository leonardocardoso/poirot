    ...
    private var keyboardShortcutsSection: some View {
        VStack(alignment: .leading, spacing: PoirotTheme.Spacing.md) {
            ...
            VStack(spacing: PoirotTheme.Spacing.xs) {
                ...
                shortcutRow("Cycle Focus", keys: "Tab")
                shortcutRow("Move Up/Down", keys: "j / k")
                shortcutRow("Open / Activate", keys: "Return / o")
                shortcutRow("Scroll Half Page", keys: "d / u")
                shortcutRow("Jump to Top/Bottom", keys: "gg / G")
                Divider().opacity(0.2)
