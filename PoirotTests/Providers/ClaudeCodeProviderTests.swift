...
struct ClaudeCodeProviderTests {
    ...
    @Test
    func navigationItems_includesAllFourteen() {
        #expect(provider.navigationItems.count == 14)
    }
    ...
    @Test
    func configurationItems_hasTenItems() {
        #expect(provider.configurationItems.count == 10)
    }
